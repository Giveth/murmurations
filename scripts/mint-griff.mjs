...
const RECIPIENT = getAddress("0x839395e20bbb182fa440d08f850e6c7a8f6f0780"); // Griff
...
console.log("▸ Griff", RECIPIENT, "balance:", balBefore.toString());
...
console.log("▸ submitting safeMintBatch([Griff])…");
...
console.log("▸ Griff balance after:", balAfter.toString());
